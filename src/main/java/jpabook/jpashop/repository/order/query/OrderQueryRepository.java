...
public class OrderQueryRepository {
    ...
    public List<OrderQueryDto> findOrderQueryDtos() {
        List<OrderQueryDto> orderQueryDtos =  findOrderQueryDtosWithoutItems();
        orderQueryDtos.stream().forEach(o -> {
    ...
    public List<OrderQueryDto> findOrderQueryDtosWithoutItems() {
    ...
    public List<OrderQueryDto> findAllByDto_optimization() {
        List<OrderQueryDto> result = findOrderQueryDtosWithoutItems();
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery("select new " +
                " jpabook.jpashop.repository.order.query.OrderFlatDto(o.id,i.name, o.orderDate, o.status, d.address, oi.orderPrice, oi.count)" +
                " from Order o" +
                " join o.member m" +
                " join o.delivery d" +
